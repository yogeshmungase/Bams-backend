...
import com.management.studenattendancesystem.base.repository.PermissionRepository;
import com.management.studenattendancesystem.base.repository.RoleRepository;
import com.management.studenattendancesystem.base.rest.mapper.UserMapper;
import com.management.studenattendancesystem.base.service.RolesService;
...
public class RolesServiceImpl implements RolesService {
    ...
    public ResponseEntity<Role> createRole(Role roleDto) {
        ...
        if (!CollectionUtils.isEmpty(permissions)) {
            if (validatePermissionsInDB(permissions)) {
                com.management.studenattendancesystem.base.db.model.Role dbRole = UserMapper.convertToDBModelRole(roleDto);
    ...
    private boolean validatePermissionsInDB(List<Permission> permissions) {
        for (Permission permission : permissions) {
            com.management.studenattendancesystem.base.db.model.Permission byNameAndStatus = permissionRepository.findByName(permission.getName());
    ...
    public ResponseEntity<Role> getRoleById(String roleId) {
        ...
        com.management.studenattendancesystem.base.db.model.Role dbRole = roleRepository.findByIdAndStatus(Long.valueOf(roleId), AMDILConstant.ACTIVE);
        if (null != dbRole) {
    ...
    public ResponseEntity<List<Role>> getRoles() {
        List<com.management.studenattendancesystem.base.db.model.Role> dbRoles = roleRepository.findAllByStatus(AMDILConstant.ACTIVE);
