...
import com.management.studenattendancesystem.base.service.PermissionsService;
...
public class PermissionsServiceImpl implements PermissionsService {
    ...
    public ResponseEntity<Permission> createPermission(Permission permissionDto) {
        com.management.studenattendancesystem.base.db.model.Permission permission = UserMapper.convertToDBPermission(permissionDto);
    ...
    public ResponseEntity<List<Permission>> getPermissions() {
        List<com.management.studenattendancesystem.base.db.model.Permission> allPermissions = permissionRepository.findAllByStatus(AMDILConstant.ACTIVE);
    ...
    public ResponseEntity<Permission> getPermissionById(String permissionId) {
        com.management.studenattendancesystem.base.db.model.Permission dbPermission = permissionRepository.findByIdAndStatus(Long.valueOf(permissionId),AMDILConstant.ACTIVE);
