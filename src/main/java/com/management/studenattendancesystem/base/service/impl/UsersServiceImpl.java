...
import com.management.studenattendancesystem.base.service.UsersService;
...
public class UsersServiceImpl implements UsersService {
    ...
    public ResponseEntity<User> createUser(User userRequest) {
        Optional<com.management.studenattendancesystem.base.db.model.User> userById = userRepository.findByEmailAndStatusActive(userRequest.getEmail());
        if (userById.isPresent()) {
            return new ResponseEntity<>(userRequest, HttpStatus.BAD_REQUEST);
        }

        com.management.studenattendancesystem.base.db.model.User user = UserMapper.convertToDBUser(userRequest);
    ...
    public ResponseEntity<Void> deleteUser(String userId) {
        com.management.studenattendancesystem.base.db.model.User dbUser = userRepository.findByIdAndStatus(Long.valueOf(userId), AMDILConstant.ACTIVE);
        if (dbUser == null) {
    ...
    public ResponseEntity<List<User>> getAllUsers() {
        List<com.management.studenattendancesystem.base.db.model.User> allUser = userRepository.findAllByStatus(AMDILConstant.ACTIVE);
    ...
    public ResponseEntity<User> updateUser(String userId, User userRequest) {
        ...
        List<com.management.studenattendancesystem.base.db.model.Role> dbRoleList = new ArrayList<>();

        for (Role role : userRequest.getRoles()) {
            com.management.studenattendancesystem.base.db.model.Role dbRole = new com.management.studenattendancesystem.base.db.model.Role(role.getName());
